...
*/	
	...
	@Test(priority = 18) // BINDU
	@Parameters({ "userType" })
	public void PWAVerifyCTA(String UserType) throws Exception {
		Zee5PWASanityBusinessLogic.reloadHome();
		Zee5PWASanityBusinessLogic.VerifyCTA(UserType);
	}
