...
//		Zee5PWAWEBMixPanelBusinessLogic.verifyAutoSeekForwardEventForContentFromUpnextRail(userType,keyword);
//	}
//	
//	@Test(priority = 176)
//	@Parameters({"freeContentURL"})
...
//		Zee5PWAWEBMixPanelBusinessLogic.verifyAutoSeekRewindEventForContentFromUpnextRail(userType,keyword);
//	}
//	
//	@Test(priority = 187)
//	@Parameters({"freeContentURL"})
...
//		Zee5PWAWEBMixPanelBusinessLogic.verifyParentalOverlayImpressionEventForContentFromUpnextRail(userType,keyword);
//	}
//	
//	@Test(priority = 198)
...
//		Zee5PWAWEBMixPanelBusinessLogic.verifyParentalOverlayResultEventForContentFromUpnextRail(userType,keyword);
//	}
//	
////	@Test(priority = 346)
//	@Parameters({"freeContentURL" ,"userType"})
